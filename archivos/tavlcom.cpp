...
void TAVLCom::rotacionesIzquierda(){
    this->raiz->iz.raiz->fe = this->raiz->iz.calcularFe();
...
void TAVLCom::rotacionesDerecha(){
    this->raiz->de.raiz->fe = this->raiz->de.calcularFe();
...
void TAVLCom::rotacionID(){
    TNodoAVL *n2 = new TNodoAVL(); // B
    TNodoAVL *n4 = new TNodoAVL(); // D
    TNodoAVL *copia = new TNodoAVL(); // F
    *copia = *this->raiz;
    *n2 = *this->raiz->iz.raiz;
    *n4 = *this->raiz->iz.raiz->de.raiz;
    copia->iz.raiz = n4->de.raiz;
    n4->de.raiz = copia;
    n2->de.raiz = n4->iz.raiz;
    n4->iz.raiz = n2;
    this->~TAVLCom();
    this->raiz = n4;
}
...
void TAVLCom::rotacionDI(){
    ...
    TNodoAVL *copia = new TNodoAVL(); // F
    *n2 = *this->raiz;
    *copia = *this->raiz->de.raiz;
    *n4 = *this->raiz->de.raiz->iz.raiz;
    n2->de = n4->iz;
    copia->iz = n4->de;
    n4->iz.raiz = n2;
    n4->de.raiz = copia;
